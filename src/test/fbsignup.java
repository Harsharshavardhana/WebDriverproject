...
public class fbsignup {
	...
	public static void main(String[] args) {
		...
		new WebDriverWait(driver, 20).until(
				ExpectedConditions.elementToBeClickable(By.xpath("//*[@data-testid='open-registration-form-button']")))
				.click();
		new WebDriverWait(driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@name='firstname']")))
				.sendKeys("xyz");
		new WebDriverWait(driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@name='lastname']")))
				.sendKeys("abcd");
		new WebDriverWait(driver, 20)
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@name='reg_email__']")))
				.sendKeys("7897944464");
		new WebDriverWait(driver, 20)
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@name='reg_passwd__']")))
				.sendKeys("xx@12345");
